...
![data example for fitting linear classifier](http://docs.opencv.org/2.4/_images/separating-lines.png)
...
![data example for fitting SV](http://docs.opencv.org/2.4/_images/optimal-hyperplane.png)
